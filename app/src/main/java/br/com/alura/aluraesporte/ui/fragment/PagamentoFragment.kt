...
class PagamentoFragment : BaseFragment() {
    ...
    private val appBarViewModel : EstadoAppViewModel by sharedViewModel()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        appBarViewModel.temComponentes = ComponentesVisuais(appBar = true)
        ...
        if (::produtoEscolhido.isInitialized) {
            viewModel.salva(pagamento)
                .observe(this, Observer {
                    it?.dado?.let {
                        Toast.makeText(activity, COMPRA_REALIZADA, Toast.LENGTH_LONG).show()
    ...
    private fun vaiParaListaProdutos() {
        val direcoes =
            PagamentoFragmentDirections.acaoPagamentosParaListaProdutos()

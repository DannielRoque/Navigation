            ...
            viewModel.componentes.observe(this, Observer {
                it?.let { temComponentes ->
                    ...
                    if(temComponentes.bottomNavigation){
                        main_activity_bottom_navigate.visibility = VISIBLE
                    }else{
                        main_activity_bottom_navigate.visibility = GONE
                    }
                }
            })
        }

        main_activity_bottom_navigate.setupWithNavController(controlador)
    }
}
